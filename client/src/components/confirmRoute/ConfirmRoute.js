...
handleRedirect = async (e) => {
  ...
  this.props.actions.fetchLyftEstimate(this.props.confirmRouteReducer.startLat, this.props.confirmRouteReducer.startLng, this.props.confirmRouteReducer.destinationLat, this.props.confirmRouteReducer.destinationLng)
  this.setState({
